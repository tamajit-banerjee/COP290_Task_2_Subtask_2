...
void ask_for_name(SDL_Renderer *renderer, TTF_Font *font, char* name, bool server){
    ...
    while (!ok) {
        ...
        SDL_RenderClear(renderer);
        if(server)
            // disp_text(renderer, "droid 1" , font, int(SCREEN_WIDTH/2) - 60, int(SCREEN_HEIGHT/2)-45);
            disp_text_center(renderer, "droid 1" , font, int(SCREEN_WIDTH/2), int(SCREEN_HEIGHT/2)-45);
        else    
            // disp_text(renderer, "droid 2" , font, int(SCREEN_WIDTH/2) - 60, int(SCREEN_HEIGHT/2)-45);
            disp_text_center(renderer, "droid 2" , font, int(SCREEN_WIDTH/2), int(SCREEN_HEIGHT/2)-45);
